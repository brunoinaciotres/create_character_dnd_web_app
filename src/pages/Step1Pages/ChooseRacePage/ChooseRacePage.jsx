    ...
    return (
        <>
            <div className="step-description">
                <div className="svg-container">
                    <span onClick={() => { setActualPage("step1") }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fff" className="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
            ...
            <div className="list-item-group">
                <div className="list-item" onClick={selectThisRace}>
                    Anão
                </div>
                <div className="list-item" onClick={selectThisRace}>
                    Elfo
